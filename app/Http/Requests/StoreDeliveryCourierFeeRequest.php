...
/**
 * Form request for storing a new delivery courier fee.
 *
 * Validates courier fee creation with strict business rules:
 ...
 */
class StoreDeliveryCourierFeeRequest extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     *
     * User must have 'manage delivery courier fees' permission to create fees.
     */
