...
/**
 * Form request for storing a new delivery courier.
 *
 * Validates delivery courier creation data including name, contact phone, and status.
 * Uses Spatie permission system for authorization.
 */
class StoreDeliveryCourierRequest extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     *
     * User must have 'manage delivery couriers' permission to create delivery couriers.
     */
     ...
     *
     * Name: Required, unique (only for active couriers), max 255 characters
    ...
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('delivery_couriers', 'name')->where(function ($query) {
