                ...
                @php
                    ...
                    $permissionGroups = [
                        ...
                        'brands' => [
                            ...
                            'permissions' => ['view brands', 'manage brands', 'delete brands']
                        ],
                        'categories' => [
                            'icon' => 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z',
                        ...
                        'cities' => [
                            ...
                            'permissions' => ['view cities', 'manage cities']
                        ],
                        'delivery_couriers' => [
                            'icon' => 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v3.28a1 1 0 00.684.948l1.498.436a1 1 0 01.651.751l1.443 4.774a1 1 0 00.95.712h1.867a1 1 0 00.95-.712l1.443-4.774a1 1 0 01.651-.751l1.498-.436A1 1 0 0017 9.28V6a1 1 0 00-1-1h-3z',
                            'title' => __('admin.delivery_couriers'),
                            'permissions' => ['view delivery couriers', 'manage delivery couriers']
                        ],
                        'delivery_courier_fees' => [
                            'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                            'title' => __('admin.delivery_courier_fees'),
                            'permissions' => ['view delivery courier fees', 'manage delivery courier fees']
                        ],
                        'orders' => [
