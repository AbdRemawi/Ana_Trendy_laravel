...
<div class="max-w-4xl mx-auto">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-900">
                        {{ $courier->created_at->format('Y-m-d H:i') }}
                    </p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-900">
                        {{ $courier->updated_at->format('Y-m-d H:i') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">
                {{ __('admin.delivery_fees_for_courier') }} ({{ $courier->deliveryFees->count() }})
            </h2>

            @if($courier->deliveryFees->count() > 0)
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach($courier->deliveryFees as $fee)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-gray-600">
                                            {{ number_format($fee->display_fee_amount, 3) }}
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-gray-600">
