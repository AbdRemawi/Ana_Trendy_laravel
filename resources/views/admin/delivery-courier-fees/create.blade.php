...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">
            {{ __('admin.create_fee_description') }}
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <form method="POST" action="{{ route('admin.delivery-courier-fees.store') }}" class="p-6">
            @csrf
                    ...
                    <select id="delivery_courier_id"
                        ...
                        @foreach($couriers as $courier)
                            <option value="{{ $courier->id }}"
                                    {{ old('delivery_courier_id') == $courier->id ? 'selected' : '' }}>
                                {{ $courier->name }}
                            </option>
                        @endforeach
                    </select>
